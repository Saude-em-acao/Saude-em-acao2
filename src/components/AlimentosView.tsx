    ...
    <section className="max-w-6xl mx-auto px-4 sm:px-6 py-10 md:py-16 space-y-8">
      ...
      <div className="text-center max-w-3xl mx-auto">
        ...
        <p className="mt-3 text-foreground/75 text-sm sm:text-base leading-relaxed">
          Consulte o nível de atenção de 58 alimentos consumidos no Brasil, descubra as principais substâncias encontradas pela Anvisa e saiba o método mais seguro de higienização.
        </p>
      </div>

      {/* Orientative Disclaimer */}
      <div className="rounded-2xl border border-border bg-card p-4 text-xs text-muted-foreground flex gap-3 items-start max-w-4xl mx-auto">
        <Info className="w-4 h-4 text-primary shrink-0 mt-0.5" />
        <div>
          <p className="leading-relaxed">{AVISO_ORIENTATIVO}</p>
          <p className="mt-1 font-medium text-foreground/80">{AVISO_HIGIENIZACAO}</p>
        </div>
      </div>
