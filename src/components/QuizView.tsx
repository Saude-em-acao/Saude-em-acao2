...
import { Award, CheckCircle, XCircle, RotateCcw, ArrowRight, Sparkles, ShieldAlert, Leaf } from "lucide-react";
      ...
      {finished && (
        <div className="mt-10 bg-card border border-border rounded-3xl p-8 md:p-12 text-center shadow-xl space-y-4">
          ...
          <p className="max-w-md mx-auto text-xs sm:text-sm text-foreground/75 leading-relaxed bg-secondary/30 p-4 rounded-2xl">
            💡 <strong>Lembre-se:</strong> lavar em água corrente reduz resíduos da casca, mas não elimina agrotóxicos sistêmicos. Prefira orgânicos, descasque sempre que possível e diversifique a alimentação para reduzir a exposição cumulativa!
          </p>
